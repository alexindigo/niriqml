...
void TestConverter::testToSnakeCase()
{
    ...
    QCOMPARE(toSnakeCase(QByteArray("posInScrollingLayout")), QByteArray("pos_in_scrolling_layout"));
    QCOMPARE(toSnakeCase(QByteArray("tilePosInWorkspaceView")), QByteArray("tile_pos_in_workspace_view"));
